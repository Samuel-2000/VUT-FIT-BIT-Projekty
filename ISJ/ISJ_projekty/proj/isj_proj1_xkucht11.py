...
def not_both_titles(names_string):
    ...
    # a name that is either preceded by [Pp]rof./[Dd]oc. and followed by Ph.D.   doc. RNDr. Petr Berka, Ph.D.,
    ...
    pat = re.compile(r'''
                (
                    ...
                    (?<![pP]rof[.])                 # it is not preceded by [Pp]rof.
                    (?<![Dd]oc[.])                  # it is not preceded by [Dd]oc.
                    |                               # or
                    (?!, Ph[.]D[.])                 # it is not followed by ', Ph.D.'   
                    [^,]*, Ph[.]D[.]
